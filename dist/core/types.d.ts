...
export declare const VIEWER_360_DEFAULTS: {
    frame: number;
    autoRotate: false;
    speed: number;
...
export interface Viewer360FrameChangeDetail {
    frame: number;
}
export interface Viewer360ZoomChangeDetail {
    level: number;
}
export interface Viewer360AutoRotateChangeDetail {
    enabled: boolean;
}
export interface Viewer360CloseDetail extends Record<string, never> {
}
export interface Viewer360ErrorDetail {
    message: string;
}
...
export interface Viewer360ElementInterface extends HTMLElement {
    ...
    reset(): void;
    addEventListener<K extends keyof Viewer360EventMap>(type: K, listener: (event: Viewer360EventMap[K]) => void, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof Viewer360EventMap>(type: K, listener: (event: Viewer360EventMap[K]) => void, options?: boolean | EventListenerOptions): void;
